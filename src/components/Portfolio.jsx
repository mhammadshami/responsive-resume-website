    ...
    <div className="container mx-auto">
      ...
      <div className='flex flex-col lg:flex-row gap-6'>
        ...
        <div className='grid grid-cols-2 gap-6 '>
          <div className="flex"><img src={portfolio.image2} alt="" /></div>
          <div className="flex"><img src={portfolio.image3} alt="" /></div>
          <div className="flex"><img src={portfolio.image4} alt="" /></div>
          <div className="flex"><img src={portfolio.image5} alt="" /></div>
        </div>
      </div>
